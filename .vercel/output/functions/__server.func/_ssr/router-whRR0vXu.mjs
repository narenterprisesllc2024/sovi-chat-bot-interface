...
import { n as getRequest, r as __exportAll } from "./ssr.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/router-whRR0vXu.js
...
var styles_default = "/assets/styles-DbezUkTg.css";
var APP_NAME = "Sovi";
var Route$20 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Sovi — adaptive cockpit for a personal AI operating system."
			}
		],
		links: [
			{
			...
			{
				rel: "stylesheet",
				href: "https://fonts.googleapis.com/css2?family=IBM+Plex+Mono:ital,wght@0,400;0,500;1,400&family=Manrope:wght@400;500;600;700;800&display=swap"
			}
		]
	}),
...
var $$splitComponentImporter$14 = () => import("../_app-D27GgR73.mjs");
var Route$19 = createFileRoute("/_app")({ component: lazyRouteComponent($$splitComponentImporter$14, "component") });
var $$splitComponentImporter$13 = () => import("./login-CCW0lAbL.mjs");
var Route$18 = createFileRoute("/login")({ component: lazyRouteComponent($$splitComponentImporter$13, "component") });
var $$splitComponentImporter$12 = () => import("../_app-CNrg5CKg.mjs");
var Route$17 = createFileRoute("/_app/")({ component: lazyRouteComponent($$splitComponentImporter$12, "component") });
var $$splitComponentImporter$11 = () => import("./agents-2CIN3On_.mjs");
var Route$16 = createFileRoute("/_app/agents")({ component: lazyRouteComponent($$splitComponentImporter$11, "component") });
var $$splitComponentImporter$10 = () => import("./artifacts-CKyeEiit.mjs");
var Route$15 = createFileRoute("/_app/artifacts")({ component: lazyRouteComponent($$splitComponentImporter$10, "component") });
var $$splitComponentImporter$9 = () => import("./automations-CXLBWnnP.mjs");
var Route$14 = createFileRoute("/_app/automations")({ component: lazyRouteComponent($$splitComponentImporter$9, "component") });
var $$splitComponentImporter$8 = () => import("./capabilities-CCIpKJn7.mjs");
var Route$13 = createFileRoute("/_app/capabilities")({ component: lazyRouteComponent($$splitComponentImporter$8, "component") });
var $$splitComponentImporter$7 = () => import("./media-DlvlQGjz.mjs");
var Route$12 = createFileRoute("/_app/media")({ component: lazyRouteComponent($$splitComponentImporter$7, "component") });
var $$splitComponentImporter$6 = () => import("./memory-Cqx5Dqor.mjs");
var Route$11 = createFileRoute("/_app/memory")({ component: lazyRouteComponent($$splitComponentImporter$6, "component") });
var $$splitComponentImporter$5 = () => import("./projects-BZgwLPCh.mjs");
var Route$10 = createFileRoute("/_app/projects")({ component: lazyRouteComponent($$splitComponentImporter$5, "component") });
var $$splitComponentImporter$4 = () => import("./system-CJCjGXQ6.mjs");
var Route$9 = createFileRoute("/_app/system")({ component: lazyRouteComponent($$splitComponentImporter$4, "component") });
var $$splitComponentImporter$3 = () => import("./design-system-iEFR0BmR.mjs");
var Route$8 = createFileRoute("/dev/design-system")({ component: lazyRouteComponent($$splitComponentImporter$3, "component") });
var $$splitComponentImporter$2 = () => import("./c._conversationId-BEkfnI3B.mjs");
var Route$7 = createFileRoute("/_app/c/$conversationId")({ component: lazyRouteComponent($$splitComponentImporter$2, "component") });
var $$splitComponentImporter$1 = () => import("./capabilities.index-DWmr_gJ3.mjs");
var Route$6 = createFileRoute("/_app/capabilities/")({ component: lazyRouteComponent($$splitComponentImporter$1, "component") });
var $$splitComponentImporter = () => import("./capabilities._capabilityId-CcRgjM3I.mjs");
var Route$5 = createFileRoute("/_app/capabilities/$capabilityId")({ component: lazyRouteComponent($$splitComponentImporter, "component") });
/**
...
var IMAGE_MODEL_FALLBACK = "grok-imagine-image";
function getXaiKey() {
	return process.env.XAI_API_KEY;
}
var SOVI_SYSTEM_PROMPT = `You are Sovi, a personal AI operating system — not a vendor chatbot and not a specific model. The human talks to Sovi; routing, tools, agents, and providers sit underneath.
...
async function streamXaiChat(opts) {
	const key = getXaiKey();
	if (!key) return new Response(JSON.stringify({ error: "AI is not available" }), {
		status: 503,
...
async function generateXaiImage(prompt) {
	...
	const attempt = async (model) => {
		...
		if (!res.ok) return { error: body.error?.message ?? `xAI image error ${res.status}` };
		const url = body.data?.[0]?.url ?? body.url;
		if (body.data?.[0]?.b64_json) return { url: `data:image/png;base64,${body.data[0].b64_json}` };
...
async function editXaiImage(prompt, imageUrl) {
	const key = getXaiKey();
	if (!key) return { error: "AI is not available" };
...
async function soviUnauthorized() {
	if (await getSessionUser()) return null;
	return Response.json({ error: "Sign in required" }, { status: 401 });
}
var Route$3 = createFileRoute("/api/sovi/chat")({ server: { handlers: { POST: async ({ request }) => {
	const denied = await soviUnauthorized();
	if (denied) return denied;
	const body = await request.json();
	const intent = body.intent ?? "chat";
	const extras = [];
	if (intent === "research") extras.push("The user is in a research task. Structure the answer with findings, evidence, uncertainties, and a suggested next step. Refer to sources by name when you cite them.");
	else if (intent === "coding") extras.push("The user is building software. Prefer a short plan, then complete code in fenced blocks. Keep the explanation human.");
	...
	if (extras.length) messages.unshift({
		role: "system",
		content: extras.join("\n")
	});
	...
	if (!upstream.ok || !upstream.body) {
		...
		return Response.json({ error: errText || `xAI error ${upstream.status}` }, { status: upstream.status || 502 });
	}
...
var Route$2 = createFileRoute("/api/sovi/image")({ server: { handlers: { POST: async ({ request }) => {
	const denied = await soviUnauthorized();
	if (denied) return denied;
	const body = await request.json();
	const prompt = (body.prompt ?? "").slice(0, 1500);
	if (!prompt) return Response.json({ error: "Missing prompt" }, { status: 400 });
	const result = body.mode === "edit" && body.imageUrl ? await editXaiImage(prompt, body.imageUrl) : await generateXaiImage(prompt);
	if (result.error) return Response.json({ error: result.error }, { status: 502 });
	return Response.json({ url: result.url });
} } } });
var Route$1 = createFileRoute("/api/sovi/status")({ server: { handlers: { GET: async () => {
	const denied = await soviUnauthorized();
	if (denied) return denied;
...
var Route = createFileRoute("/api/sovi/tts")({ server: { handlers: { POST: async ({ request }) => {
	const denied = await soviUnauthorized();
	if (denied) return denied;
...
var AppAgentsRoute = Route$16.update({
	id: "/agents",
	path: "/agents",
	getParentRoute: () => AppRoute
});
var AppArtifactsRoute = Route$15.update({
	id: "/artifacts",
	path: "/artifacts",
	getParentRoute: () => AppRoute
});
var AppAutomationsRoute = Route$14.update({
	id: "/automations",
	path: "/automations",
	getParentRoute: () => AppRoute
});
var AppCapabilitiesRoute = Route$13.update({
	id: "/capabilities",
	path: "/capabilities",
	getParentRoute: () => AppRoute
});
var AppMediaRoute = Route$12.update({
	id: "/media",
	path: "/media",
	getParentRoute: () => AppRoute
});
var AppMemoryRoute = Route$11.update({
	id: "/memory",
	path: "/memory",
	getParentRoute: () => AppRoute
});
...
var AppSystemRoute = Route$9.update({
	id: "/system",
	path: "/system",
	getParentRoute: () => AppRoute
});
var DevDesignSystemRoute = Route$8.update({
	id: "/dev/design-system",
	path: "/dev/design-system",
	getParentRoute: () => Route$20
});
var AppCConversationIdRoute = Route$7.update({
	id: "/c/$conversationId",
	path: "/c/$conversationId",
	getParentRoute: () => AppRoute
});
var AppCapabilitiesIndexRoute = Route$6.update({
	id: "/",
	path: "/",
	getParentRoute: () => AppCapabilitiesRoute
});
var AppCapabilitiesCapabilityIdRoute = Route$5.update({
	id: "/$capabilityId",
	path: "/$capabilityId",
	getParentRoute: () => AppCapabilitiesRoute
});
...
var ApiSoviChatRoute = Route$3.update({
	id: "/api/sovi/chat",
	path: "/api/sovi/chat",
	getParentRoute: () => Route$20
});
var ApiSoviImageRoute = Route$2.update({
	id: "/api/sovi/image",
	path: "/api/sovi/image",
	getParentRoute: () => Route$20
});
var ApiSoviStatusRoute = Route$1.update({
	id: "/api/sovi/status",
	path: "/api/sovi/status",
	getParentRoute: () => Route$20
});
var ApiSoviTtsRoute = Route.update({
	id: "/api/sovi/tts",
	path: "/api/sovi/tts",
	getParentRoute: () => Route$20
});
var AppCapabilitiesRouteChildren = {
	AppCapabilitiesCapabilityIdRoute,
	AppCapabilitiesIndexRoute
};
var AppRouteChildren = {
	AppAgentsRoute,
	AppArtifactsRoute,
	AppAutomationsRoute,
	AppCapabilitiesRoute: AppCapabilitiesRoute._addFileChildren(AppCapabilitiesRouteChildren),
	AppMediaRoute,
	AppMemoryRoute,
	AppProjectsRoute,
	AppSystemRoute,
	AppIndexRoute,
	AppCConversationIdRoute
};
...
//#endregion
export { getBaseURL as a, PACKAGE_VERSION as i, GROK_PROVIDERS as n, Route$5 as o, GENERIC_OAUTH_ERROR_CODES as r, Route$7 as s, router_exports as t };
