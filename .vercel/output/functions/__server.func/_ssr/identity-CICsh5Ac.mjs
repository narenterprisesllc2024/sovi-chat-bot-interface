...
import { a as getBaseURL, i as PACKAGE_VERSION, r as GENERIC_OAUTH_ERROR_CODES } from "./router-whRR0vXu.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/identity-CICsh5Ac.js
...
var buttonVariants = cva("inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-[color,background-color,box-shadow,transform,opacity] duration-150 ease-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring/70 disabled:pointer-events-none disabled:opacity-40 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:not-disabled:scale-[0.96]", {
	variants: {
		variant: {
			...
			horizon: "bg-horizon text-primary-foreground hover:opacity-90"
		},
		size: {
			default: "h-10 px-4",
...
var DEFAULT_IDENTITY = { markId: "dawn" };
var MARK_OPTIONS = [
	{
		id: "dawn",
		name: "Dawn",
		detail: "Horizon + rising amber point. Default chrome."
	},
	{
		id: "horizon",
		name: "Horizon",
		detail: "Single-color cyan mark for quieter chrome."
	},
	{
		id: "crest",
		name: "Crest",
		detail: "Sculptural emblem — the rendered Sovi mark."
	},
	{
		id: "custom",
		name: "Your mark",
		detail: "Upload an image. SVG, PNG, or JPEG, square."
	}
];
var CREST_SRC = "/brand/sovi-crest.jpg";
//#endregion
export { authClient as a, formatRelativeTime as c, signIn as d, signOut as f, MARK_OPTIONS as i, getBearerToken as l, truncate as m, CREST_SRC as n, cn as o, sleep as p, DEFAULT_IDENTITY as r, createId as s, Button as t, greetingForNow as u };
